...
const DISC_ICON_POOLS = {
  Ninjutsu: [
    `${M}/spells/fireball-red-1.jpg`,
    `${M}/spells/fireball-red-2.jpg`,
    `${M}/spells/fireball-red-3.jpg`,
    `${M}/spells/fireball-sky-1.jpg`,
    `${M}/spells/fireball-sky-2.jpg`,
    `${M}/spells/fireball-sky-3.jpg`,
    `${M}/spells/fireball-eerie-1.jpg`,
    `${M}/spells/fireball-eerie-2.jpg`,
    `${M}/spells/fireball-eerie-3.jpg`,
    `${M}/spells/explosion-red-1.jpg`,
    `${M}/spells/explosion-red-2.jpg`,
    `${M}/spells/explosion-red-3.jpg`,
    `${M}/spells/explosion-orange-1.jpg`,
    `${M}/spells/explosion-orange-2.jpg`,
    `${M}/spells/explosion-orange-3.jpg`,
    `${M}/spells/explosion-sky-1.jpg`,
    `${M}/spells/explosion-sky-2.jpg`,
    `${M}/spells/explosion-sky-3.jpg`,
    `${M}/spells/beam-red-1.jpg`,
    `${M}/spells/beam-red-2.jpg`,
    `${M}/spells/beam-red-3.jpg`,
    `${M}/spells/beam-blue-1.jpg`,
    `${M}/spells/beam-blue-2.jpg`,
    `${M}/spells/beam-blue-3.jpg`,
    `${M}/spells/beam-orange-1.jpg`,
    `${M}/spells/beam-orange-2.jpg`,
    `${M}/spells/beam-orange-3.jpg`,
    `${M}/spells/beam-sky-1.jpg`,
    `${M}/spells/beam-sky-2.jpg`,
    `${M}/spells/beam-sky-3.jpg`,
    `${M}/spells/beam-eerie-1.jpg`,
    `${M}/spells/beam-eerie-2.jpg`,
    `${M}/spells/beam-eerie-3.jpg`,
    `${M}/spells/fire-arrows-1.jpg`,
    `${M}/spells/fire-arrows-2.jpg`,
    `${M}/spells/fire-arrows-3.jpg`,
    `${M}/spells/fire-arrows-sky-1.jpg`,
    `${M}/spells/fire-arrows-sky-2.jpg`,
    `${M}/spells/fire-arrows-sky-3.jpg`,
    `${M}/spells/lighting-fire-1.jpg`,
    `${M}/spells/lighting-fire-2.jpg`,
    `${M}/spells/lighting-fire-3.jpg`,
    `${M}/spells/lighting-royal-1.jpg`,
    `${M}/spells/lighting-royal-2.jpg`,
    `${M}/spells/lighting-royal-3.jpg`,
    `${M}/spells/lighting-sky-1.jpg`,
    `${M}/spells/lighting-sky-2.jpg`,
    `${M}/spells/lighting-sky-3.jpg`,
    `${M}/spells/rock-orange-1.jpg`,
    `${M}/spells/rock-orange-2.jpg`,
    `${M}/spells/rock-orange-3.jpg`,
    `${M}/spells/rock-royal-1.jpg`,
    `${M}/spells/rock-royal-2.jpg`,
    `${M}/spells/rock-royal-3.jpg`,
    `${M}/spells/wind-sky-1.jpg`,
    `${M}/spells/wind-sky-2.jpg`,
    `${M}/spells/wind-sky-3.jpg`,
    `${M}/spells/wind-red-1.jpg`,
    `${M}/spells/wind-red-2.jpg`,
    `${M}/spells/wind-red-3.jpg`,
    `${M}/spells/air-burst-air-1.jpg`,
    `${M}/spells/air-burst-air-2.jpg`,
    `${M}/spells/air-burst-air-3.jpg`,
    `${M}/spells/needles-fire-1.jpg`,
    `${M}/spells/needles-fire-2.jpg`,
    `${M}/spells/needles-fire-3.jpg`,
    `${M}/spells/rip-sky-1.jpg`,
    `${M}/spells/rip-sky-2.jpg`,
    `${M}/spells/rip-sky-3.jpg`,
    `${M}/spells/slice-orange-1.jpg`,
    `${M}/spells/slice-orange-2.jpg`,
    `${M}/spells/slice-orange-3.jpg`,
    `${M}/spells/vines-jade-1.jpg`,
    `${M}/spells/vines-jade-2.jpg`,
    `${M}/spells/vines-jade-3.jpg`,
  ],
  Taijutsu: [
    `${M}/feats/stunning-fist.jpg`,
    `${M}/feats/improved-unarmed-strike.jpg`,
    `${M}/feats/power-attack.jpg`,
    `${M}/feats/combat-reflexes.jpg`,
    `${M}/feats/vital-strike.jpg`,
    `${M}/feats/improved-vital-strike.jpg`,
    `${M}/feats/greater-vital-strike.jpg`,
    `${M}/feats/weapon-finesse.jpg`,
    `${M}/feats/cleave.jpg`,
    `${M}/feats/great-cleave.jpg`,
    `${M}/feats/dodge.jpg`,
    `${M}/feats/combat-expertise.jpg`,
    `${M}/feats/improved-grapple.jpg`,
    `${M}/feats/greater-grapple.jpg`,
    `${M}/feats/improved-trip.jpg`,
    `${M}/feats/greater-trip.jpg`,
    `${M}/feats/improved-disarm.png`,
    `${M}/feats/scorpion-style.jpg`,
    `${M}/feats/shatter-defenses.jpg`,
    `${M}/feats/medusas-wrath.jpg`,
    `${M}/feats/deadly-stroke.jpg`,
    `${M}/feats/whirlwind-attack.jpg`,
    `${M}/feats/spring-attack.jpg`,
    `${M}/feats/lunge.jpg`,
    `${M}/feats/mobility.jpg`,
    `${M}/feats/acrobatic.jpg`,
    `${M}/feats/acrobatic-step.png`,
    `${M}/feats/athletic.jpg`,
    `${M}/feats/blind-fight.jpg`,
    `${M}/feats/deflect-arrows.jpg`,
    `${M}/feats/gorgons-fist.jpg`,
    `${M}/feats/improved-critical.jpg`,
    `${M}/skills/weapon_01.jpg`,
    `${M}/skills/weapon_02.jpg`,
    `${M}/skills/weapon_03.jpg`,
    `${M}/skills/weapon_04.jpg`,
    `${M}/skills/weapon_05.jpg`,
    `${M}/skills/weapon_06.jpg`,
    `${M}/skills/weapon_07.jpg`,
    `${M}/skills/weapon_08.jpg`,
    `${M}/skills/weapon_09.jpg`,
    `${M}/skills/weapon_10.jpg`,
    `${M}/skills/weapon_11.jpg`,
    `${M}/skills/weapon_12.jpg`,
    `${M}/skills/weapon_13.jpg`,
    `${M}/skills/weapon_14.jpg`,
    `${M}/skills/weapon_15.jpg`,
    `${M}/skills/weapon_16.jpg`,
    `${M}/skills/weapon_17.jpg`,
    `${M}/skills/weapon_18.jpg`,
    `${M}/skills/weapon_20.jpg`,
    `${M}/skills/weapon_22.jpg`,
    `${M}/skills/weapon_25.jpg`,
    `${M}/spells/slice-sky-1.jpg`,
    `${M}/spells/slice-sky-2.jpg`,
    `${M}/spells/slice-sky-3.jpg`,
    `${M}/spells/rip-acid-1.jpg`,
    `${M}/spells/rip-acid-2.jpg`,
    `${M}/spells/rip-acid-3.jpg`,
  ],
  "Chakra Control": [
    `${M}/spells/enchant-blue-1.jpg`,
    `${M}/spells/enchant-blue-2.jpg`,
    `${M}/spells/enchant-blue-3.jpg`,
    `${M}/spells/enchant-jade-1.jpg`,
    `${M}/spells/enchant-jade-2.jpg`,
    `${M}/spells/enchant-jade-3.jpg`,
    `${M}/spells/enchant-sky-1.jpg`,
    `${M}/spells/enchant-sky-2.jpg`,
    `${M}/spells/enchant-sky-3.jpg`,
    `${M}/spells/enchant-royal-1.jpg`,
    `${M}/spells/enchant-royal-2.jpg`,
    `${M}/spells/enchant-royal-3.jpg`,
    `${M}/spells/heal-jade-1.jpg`,
    `${M}/spells/heal-jade-2.jpg`,
    `${M}/spells/heal-jade-3.jpg`,
    `${M}/spells/heal-royal-1.jpg`,
    `${M}/spells/heal-royal-2.jpg`,
    `${M}/spells/heal-royal-3.jpg`,
    `${M}/spells/heal-sky-1.jpg`,
    `${M}/spells/heal-sky-2.jpg`,
    `${M}/spells/heal-sky-3.jpg`,
    `${M}/spells/light-blue-1.jpg`,
    `${M}/spells/light-blue-2.jpg`,
    `${M}/spells/light-blue-3.jpg`,
    `${M}/spells/light-jade-1.jpg`,
    `${M}/spells/light-jade-2.jpg`,
    `${M}/spells/light-jade-3.jpg`,
    `${M}/spells/light-royal-1.jpg`,
    `${M}/spells/light-royal-2.jpg`,
    `${M}/spells/light-royal-3.jpg`,
    `${M}/spells/protect-blue-1.jpg`,
    `${M}/spells/protect-blue-2.jpg`,
    `${M}/spells/protect-blue-3.jpg`,
    `${M}/spells/haste-sky-1.jpg`,
    `${M}/spells/haste-sky-2.jpg`,
    `${M}/spells/haste-sky-3.jpg`,
    `${M}/spells/haste-royal-1.jpg`,
    `${M}/spells/haste-royal-2.jpg`,
    `${M}/spells/haste-royal-3.jpg`,
    `${M}/spells/link-blue-1.jpg`,
    `${M}/spells/link-blue-2.jpg`,
    `${M}/spells/link-blue-3.jpg`,
  ],
  Genjutsu: [
    `${M}/spells/evil-eye-eerie-1.jpg`,
    `${M}/spells/evil-eye-eerie-2.jpg`,
    `${M}/spells/evil-eye-eerie-3.jpg`,
    `${M}/spells/evil-eye-red-1.jpg`,
    `${M}/spells/evil-eye-red-2.jpg`,
    `${M}/spells/evil-eye-red-3.jpg`,
    `${M}/spells/horror-eerie-1.jpg`,
    `${M}/spells/horror-eerie-2.jpg`,
    `${M}/spells/horror-eerie-3.jpg`,
    `${M}/spells/horror-red-1.jpg`,
    `${M}/spells/horror-red-2.jpg`,
    `${M}/spells/horror-red-3.jpg`,
    `${M}/spells/horror-acid-1.jpg`,
    `${M}/spells/horror-acid-2.jpg`,
    `${M}/spells/horror-acid-3.jpg`,
    `${M}/spells/fog-magenta-1.jpg`,
    `${M}/spells/fog-magenta-2.jpg`,
    `${M}/spells/fog-magenta-3.jpg`,
    `${M}/spells/fog-orange-1.jpg`,
    `${M}/spells/fog-orange-2.jpg`,
    `${M}/spells/fog-orange-3.jpg`,
    `${M}/spells/fog-blue-1.jpg`,
    `${M}/spells/fog-blue-2.jpg`,
    `${M}/spells/fog-blue-3.jpg`,
    `${M}/spells/wild-eerie-1.jpg`,
    `${M}/spells/wild-eerie-2.jpg`,
    `${M}/spells/wild-eerie-3.jpg`,
    `${M}/skills/shadow_01.jpg`,
    `${M}/skills/shadow_02.jpg`,
    `${M}/skills/shadow_03.jpg`,
    `${M}/skills/shadow_04.jpg`,
    `${M}/skills/shadow_05.jpg`,
    `${M}/skills/shadow_06.jpg`,
    `${M}/skills/shadow_07.jpg`,
    `${M}/skills/shadow_08.jpg`,
    `${M}/skills/shadow_09.jpg`,
    `${M}/skills/shadow_10.jpg`,
    `${M}/skills/shadow_11.jpg`,
    `${M}/skills/shadow_12.jpg`,
    `${M}/skills/violet_01.jpg`,
    `${M}/skills/violet_03.jpg`,
    `${M}/skills/violet_05.jpg`,
    `${M}/skills/violet_07.jpg`,
    `${M}/skills/violet_09.jpg`,
    `${M}/skills/violet_11.jpg`,
  ],
  Fuinjutsu: [
    `${M}/spells/runes-blue-1.jpg`,
    `${M}/spells/runes-blue-2.jpg`,
    `${M}/spells/runes-blue-3.jpg`,
    `${M}/spells/runes-magenta-1.jpg`,
    `${M}/spells/runes-magenta-2.jpg`,
    `${M}/spells/runes-magenta-3.jpg`,
    `${M}/spells/runes-orange-1.jpg`,
    `${M}/spells/runes-orange-2.jpg`,
    `${M}/spells/runes-orange-3.jpg`,
    `${M}/spells/runes-royal-1.jpg`,
    `${M}/spells/runes-royal-2.jpg`,
    `${M}/spells/runes-royal-3.jpg`,
    `${M}/spells/link-blue-1.jpg`,
    `${M}/spells/link-blue-2.jpg`,
    `${M}/spells/link-blue-3.jpg`,
    `${M}/spells/link-eerie-1.jpg`,
    `${M}/spells/link-eerie-2.jpg`,
    `${M}/spells/link-eerie-3.jpg`,
    `${M}/spells/link-royal-1.jpg`,
    `${M}/spells/link-royal-2.jpg`,
    `${M}/spells/link-royal-3.jpg`,
    `${M}/spells/link-spirit-1.jpg`,
    `${M}/spells/link-spirit-2.jpg`,
    `${M}/spells/link-spirit-3.jpg`,
    `${M}/spells/shielding-acid-1.jpg`,
    `${M}/spells/shielding-acid-2.jpg`,
    `${M}/spells/shielding-acid-3.jpg`,
    `${M}/spells/shielding-eerie-1.jpg`,
    `${M}/spells/shielding-eerie-2.jpg`,
    `${M}/spells/shielding-eerie-3.jpg`,
    `${M}/spells/shielding-spirit-1.jpg`,
    `${M}/spells/shielding-spirit-2.jpg`,
    `${M}/spells/shielding-spirit-3.jpg`,
    `${M}/spells/protect-red-1.jpg`,
    `${M}/spells/protect-red-2.jpg`,
    `${M}/spells/protect-red-3.jpg`,
    `${M}/spells/protect-magenta-1.jpg`,
    `${M}/spells/protect-magenta-2.jpg`,
    `${M}/spells/protect-magenta-3.jpg`,
  ],
  Training: [
    `${M}/feats/skill-focus.jpg`,
    `${M}/feats/iron-will.jpg`,
    `${M}/feats/toughness.jpg`,
    `${M}/feats/endurance.png`,
    `${M}/feats/great-fortitude.jpg`,
    `${M}/feats/lighting-reflexes.jpg`,
    `${M}/feats/improved-initiative.jpg`,
    `${M}/feats/alertness.jpg`,
    `${M}/feats/combat-casting.jpg`,
    `${M}/feats/magical-aptitude.jpg`,
    `${M}/feats/self-suficient.jpg`,
    `${M}/feats/persuasive.jpg`,
    `${M}/feats/diehard.jpg`,
    `${M}/feats/improved-iron-will.jpg`,
...
function parseComponents(raw, techName) {
  ...
  for (const token of tokens) {
    ...
    if (t === "C" || t === "CONCENTRATION") flags.compConcentration = true;
      ...
      continue; // Material focus — no boolean field, kept as description text
...
function resolveRankComplexity(record, flags, techName) {
  ...
  if (!Number.isFinite(learnDC) && !Number.isFinite(successes) && !Number.isFinite(performDC)) {
    ...
    return {
      rank: Number.isFinite(bookRank) ? bookRank : 1,
      complexity: bookComplexity ?? "E-Class",
      fitted: true,
    };
  }
...
for (const record of records) {
  ...
  if (storedRank !== rank) {
    warn(
      `${name}: rank ${rank} clamped to ${storedRank} (schema max); true rank kept in description`,
    );
  }
  ...
  const doc = {
    ...
    effects: [],
    folder: ensureFolder([discipline, subtype || "General", String(storedRank).padStart(2, "0")]),
    sort: 0,
    ownership: { default: 0 },
    flags: {},
    _key: `!items!${id}`,
...
console.log(
  `${DRY_RUN ? "[dry-run] Would import" : "Imported"} ${created.length} techniques, ` +
