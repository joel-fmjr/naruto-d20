...
export const TECHNIQUE_DESCRIPTORS = [
    ...
    "All Villages Kinjutsu",
    "Amegakure Hijutsu",
    "Amegakure Kinjutsu",
    "ANBU Hijutsu",
    "Aoyama Motoko Hijutsu",
    "Armed",
    "Armed or Punch",
    "Armor",
    "Chaotic",
    ...
    "Combination",
    "Darkness",
    "Dattoumaru Clan Hijutsu",
    "Death",
    "Deidara Kinjutsu",
    "Earth",
    "Electric",
    "Electric; Hatake Kakashi Hijutsu",
    "Evil",
    "Fear",
    "Fire",
    "Force",
    "Good",
    "Grapple",
    "Gumoshin Clan Hijutsu",
    "Gumoshin Hijutsu",
    "Haku Hijutsu",
    "Haruno Sakura hijutsu",
    "Hatake Kakashi Hijutsu",
    "Hidan Kinjutsu",
    "Hijutsu",
    "Himashin Clan Hijutsu",
    "Hoshigake Kisame Hijutsu",
    "Hyuuga Clan Hijutsu",
    "Hyuuga Clan Kinjutsu",
    "Inuzuka Clan Hijutsu",
    "Inuzuka Clan Kinjutsu",
    "Ishimaru Clan Hijutsu",
    "Ishimaru Hijutsu",
    "Iwagakure Kinjutsu",
    "Jiraiya Hijutsu",
    "Jiraiya Kinjutsu",
    "Kagetsuki Clan Hijutsu",
    "Kaguya Clan Hijutsu",
    "Kaguya Clan Kinjutsu",
    "Kazahana Clan Hijutsu",
    "Kedoui Clan Kinjutsu",
    "Kick",
    "Kick or Punch",
    "Kinjutsu",
    "Konoha Hijutsu",
    ...
    "Saitou Hajime Hijutsu",
    "Sandaime Hokage Hijutsu",
    "Sandaime Kazekage Kinjutsu",
    "Sarutobi Asuma Hijutsu",
    "Shiroikumo Suzuyoshi Hijutsu",
    "Shiseiten no Akira Hijutsu",
    "Shodaime Hokage Hijutsu",
    "Sleep",
    "Sonic",
    "Summoning",
    "Sunagakure Hijutsu",
    ...
    "Takigakure Hijutsu",
    "Teleportation",
    "Tenshunreiken Clan Hijutsu",
    "Tsunade Hijutsu",
    "Uchiha Clan Hijutsu",
    "Uchiha Clan Kinjutsu",
    "Uchiha Itachi Hijutsu",
    "Uchiha Sasuke Hijutsu",
    "Uzumaki Naruto Hijutsu",
    "Uzumaki Naruto Kinjutsu",
    "varies",
    "Varies",
    "Water",
    "Wind",
    "Wood",
    "Yamanaka Clan Hijutsu",
    "Yondaime Hokage Hijutsu",
    "Yuuhi Kurenai Hijutsu",
];
