...
// PF1e registry keys. The module namespace is passed separately at registration.
export const LOW_RESERVES_CONDITION_ID = "lowReserves";
export const CHAKRA_DEPLETION_CONDITION_ID = "chakraDepletion";
